import { helloWorld } from "../assets/index.js";
const Hero = () => (
    <section id="home" className={`w-full h-screen flex md:flex-row flex-col items-center md:justify-between justify-start my-5 px-10`}>
        <div className={`md:w-1/2 w-full h-full flex flex-col items-start justify-center text-center`}>
            ...
            <h1 className={`text-[42px] text-start text-dimWhite font-semibold`}>
                Software
                <br className={'md:hidden block'}/>
                <span className={`text-white md:text-inherit text-[52px] font-semibold`}> Engineer</span>
            </h1>
            <p className={`text-[22px] text-start text-dimWhite font-normal mt-20`}>
        ...
        <div className={`md:ml-5 h-full flex flex-col justify-center items-center mt-10 md:w-1/2 w-full`}>
