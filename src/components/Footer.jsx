const Footer = () => {
   ...
   return (
    <footer className="bg-transparent w-full px-20">
        <div className="relative mx-auto w-full px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
            ...
            <div>
                <div className="flex justify-center text-teal-600 lg:justify-start">
                    <a href="#hero" className={'md:w-1/4 w-auto flex items-baseline justify-start cursor-pointer'}>
                ...
                Skilled Software Engineer making my way into the global market with commitment and great ambition for creating innovative products.
                </p>
            </div>
            ...
            >
                ...
                <li>
                <a className="text-gray-700 transition hover:text-gray-700/75" href="#portfolio"> Projects </a>
                </li>
