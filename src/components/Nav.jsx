import {reactImg, menu, close} from "../assets/index.js";
...
const Nav = () => {
    ...
    return (
        <section id="nav" className={`absolute top-0 left-0 w-full flex flex-row items-center justify-between pt-10 px-5`}>
            <div className={'md:w-1/4 w-auto pl-4'}>
            ...
            <div className={'md:w-2/4 w-auto'}>
                ...
                <div
                    className={`absolute top-20 right-4 rounded-[15px] text-white text-[18px] w-[200px] bg-licorice ${isMenuCollapsed ? 'hidden' : 'flex'} slide-top-to-bottom flex-col items-center justify-start py-5`}>
